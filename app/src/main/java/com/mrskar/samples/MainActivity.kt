...
class MainActivity : AppCompatActivity() {
    ...
    private val items = listOf(
        ...
        ContentModel("Contenido 2", "Prueba con el contenido estatico"),
        ContentModel("Contenido 3", "Prueba con el contenido estatico"),
        ContentModel("Contenido 4", "Prueba con el contenido estatico"),
        ContentModel("Contenido 5", "Prueba con el contenido estatico"),
        ContentModel("Contenido 6", "Prueba con el contenido estatico"),
        ContentModel("Contenido 7", "Prueba con el contenido estatico"),
        ContentModel("Contenido 8", "Prueba con el contenido estatico"),
        ContentModel("Contenido 9", "Prueba con el contenido estatico"),
        ContentModel("Contenido 10", "Prueba con el contenido estatico"),
